...
def draw(draw_info, sorting_algo_name, ascending):
    ...
    title = draw_info.LARGE_FONT.render(f"{sorting_algo_name} - {'Ascending' if ascending else 'Descending'}", 1, draw_info.BLUE)
...
async def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.key == pygame.K_r and sorting == False:
                lst = generate_starting_list(n, min_val, max_val)
